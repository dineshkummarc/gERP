...
/* *****************************************************************************
 *             ADMISSION MODULE FUNCTIONS STARTS HERE                          *
 * *****************************************************************************
 */
...
xmlhttp.open("GET","ajax/add_no.php",true);
xmlhttp.send();
...
xmlhttp.open("GET","dist.php",true);
xmlhttp.send();

}

/* *****************************************************************************
 *             ADMISSION MODULE FUNCTIONS ENDS HERE                            *
 * *****************************************************************************
 */
...
function add_other_admin_department() {
	...
	if(val!='Training And Placement'){
		...
		xmlhttp.open("GET","ajax/add_other_admin_department.php",true);
		xmlhttp.send();
	}
	else {
